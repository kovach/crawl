...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_CHIMERA,           SK_MACES_FLAILS,   -3),
    APT(SP_CHIMERA,           SK_POLEARMS,       -3),
    APT(SP_CHIMERA,           SK_STAVES,         -3),
    ...
    APT(SP_JELLY_MAN,           SK_SHORT_BLADES,   UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_LONG_BLADES,    UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_AXES,           UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_MACES_FLAILS,   UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_POLEARMS,       UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_STAVES,         UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_SLINGS,         UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_BOWS,           UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_CROSSBOWS,      UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_THROWING,       UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_ARMOUR,         UNUSABLE_SKILL),
    APT(SP_JELLY_MAN,           SK_DODGING,        -2),
    APT(SP_JELLY_MAN,           SK_STEALTH,        -1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_JELLY_MAN,           SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_JELLY_MAN,           SK_SHIELDS,        UNUSABLE_SKILL),
#if TAG_MAJOR_VERSION == 34
    APT(SP_JELLY_MAN,           SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_JELLY_MAN,           SK_UNARMED_COMBAT,  0),
